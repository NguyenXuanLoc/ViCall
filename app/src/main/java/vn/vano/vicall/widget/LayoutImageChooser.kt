...
class LayoutImageChooser(context: Context?, attrs: AttributeSet?) :
    ...
    init {
        ...
        layoutInflater.inflate(R.layout.layout_image_chooser, this, true)
        ...
        imgRemove.setOnSafeClickListener {
